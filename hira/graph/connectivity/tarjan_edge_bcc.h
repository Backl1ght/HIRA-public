#ifndef HIRA_GRAPH_CONNECTIVITY_TARJAN_EDGE_BCC_H
#define HIRA_GRAPH_CONNECTIVITY_TARJAN_EDGE_BCC_H
...
std::vector<std::vector<int>> TarjanEdgeBCC(
    int n,
...
#endif  // HIRA_GRAPH_CONNECTIVITY_TARJAN_EDGE_BCC_H