#ifndef HIRA_GRAPH_CONNECTIVITY_TARJAN_POINT_BCC_H
#define HIRA_GRAPH_CONNECTIVITY_TARJAN_POINT_BCC_H
...
std::vector<std::vector<int>> TarjanPointBCC(
...
#endif  // HIRA_GRAPH_CONNECTIVITY_TARJAN_POINT_BCC_H